...
function filterMenu(category) {
    ...
    if (category === 'all') {
        ...
        // clear visual order (we rebuild order)
        order.forEach(cat => {
            ...
            items
                ...
                .forEach(item => {
                    ...
                    // IMPORTANT: this keeps items inside SAME category block naturally
...
function getCategory(item) {
    if (item.classList.contains('coffee')) return 'coffee';
    if (item.classList.contains('drinks')) return 'drinks';
    if (item.classList.contains('pizza')) return 'pizza';
    if (item.classList.contains('dessert')) return 'dessert';
    if (item.classList.contains('sandwich')) return 'sandwich';
    if (item.classList.contains('pasta')) return 'pasta';
    return 'unknown';
}
