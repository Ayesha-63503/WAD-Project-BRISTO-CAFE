...
<html lang="en">
    <head> 
        ...
        <title>Baresto Brewed Coffee Shop</title>
    ...
    <div class="home-container">
        ...
        <div class="hero-image">
            <img src="assets/images/cup.png" alt="Coffee Cup">
        </div>
    </div>
</section>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    <h3>Welcome to Baresto!</h3>
                    <p>
                        At Baristo, we believe coffee is more than just a drink—it’s a daily ritual 
                        that brings comfort, energy, and connection. 
                        Every cup we serve is crafted with care, using quality beans 
                        and a passion for rich, authentic flavor. Whether you’re stopping by for a 
                        quick boost or settling in to unwind, Baristo offers a warm 
                        and inviting space where every moment feels special. 
                        Our goal is simple: to create a memorable coffee experience 
                        that keeps you coming back, one perfect cup at a time.
                    </p>
                    <p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="assets/images/sar.jpeg" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                                        <i class="fas fa-star"></i>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="assets/images/muq.jpeg" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                                        <i class="fas fa-star"></i>
                    ...
                    <div class="row pic-to-hide">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="assets/images/ashi.jpeg" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                                        <i class="fas fa-star"></i>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="assets/images/sarah1.jpeg" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                                        <i class="fas fa-star"></i>
        ...
        <section class="contact" id="contact">
            ...
            <div class="row">
                ...
                <form name="contact" method="POST" action="https://formspree.io/f/mreryjkd">
        ...
        <section class="footer">
            <div class="footer-container">
                <div class="logo">
                    ...
                    <p>bareeraamjad04@gmail.com</p><br />
                    <i class="fas fa-phone"></i>
                    <p>+923020501394</p><br />
                    <i class="fab fa-facebook-messenger"></i>
                    <p>@Barestocoffee</p><br />
                </div>
                <div class="support">
    ...
    <a href="javascript:void(0);" onclick="document.getElementById('chat-button').click()">Chatbot Inquiry</a>
    <a href="ticket.php">Submit a Ticket</a>
</div>
                ...
                <div class="full-chat-block">
                    ...
                    <div class="outer-container">
                        <div class="chat-container">
                            ...
                            <button onclick="quickMsg('menu')">Menu</button>
                            <button onclick="quickMsg('contact')">Contact</button>
                            <button onclick="quickMsg('order')">How to Order</button>
                                 </div>
                                <div id="userInput">
...
const chatBox = document.querySelector(".chat-bar-collapsible .content");
...
document.getElementById("cart-btn").onclick = function () {
    document.getElementById("cart-panel").classList.toggle("active");
     ...
     <script>
document.addEventListener("DOMContentLoaded", function () {
    // ensure cart works after DOM loads
