...
<html lang="en">
    ...
    <body>
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to Baresto Brewed Coffee Shop, <?php echo $_SESSION['username']; ?>!</h3>
                <p>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    ...
                    <p>
                        At Baresto brewed Coffee Shop, we are passionate about coffee and believe
                    ...
                    <p>
                        ...
                        inviting atmosphere at Baresto is designed to be a haven
        ...
        <section class="footer">
            <div class="footer-container">
                ...
                <div class="credit">
                    <hr /><br/>
                    <h2>Baresto Brewed Coffee © 2023 | All Rights Reserved.</h2>
